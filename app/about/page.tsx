      ...
      <section className="border-t border-border/50 bg-card/50 py-20">
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex flex-col items-center gap-12 lg:flex-row-reverse lg:gap-16">
            ...
            <div className="flex-shrink-0">
              <div className="relative">
                <div className="absolute -inset-2 rounded-full bg-primary/20 blur-lg glow-pulse" />
                <div className="relative h-56 w-56 overflow-hidden rounded-full border-4 border-primary bg-card md:h-72 md:w-72">
                  <img
                    src="/images/kainat.jpg.jpg"
                    alt="Kainat Asif - Co-founder of Induction.io"
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="mt-4 max-w-xl text-pretty leading-relaxed text-muted-foreground">
                ...
                building teams that scale. Kainat ensures our solutions remain practical,
